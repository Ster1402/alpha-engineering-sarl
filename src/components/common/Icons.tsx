...
const Icons = {
  ...
  google: FaGoogle,
  line: ({ className, ...props }: React.HTMLAttributes<HTMLImageElement>) => {
    return (
      <Image
        src={"/images/line.svg"}
        width={100}
  ...
  line2: ({ className, ...props }: React.HTMLAttributes<HTMLImageElement>) => {
    return (
      <Image
  ...
  world: ({ className, ...props }: React.HTMLAttributes<HTMLImageElement>) => {
    return (
      <Image
        priority={false}
  ...
  logo: ({ className }: React.LinkHTMLAttributes<HTMLLinkElement>) => (
    <Link className={cn("w-48", className)} href={ROUTES.HOME}>
      <Image
        width={160}
        height={96}
        src={"/assets/images/PNG/logo_large.png"}
  ...
  logo_white: ({ className }: React.LinkHTMLAttributes<HTMLLinkElement>) => (
    <Link className={cn("w-48", className)} href={ROUTES.HOME}>
      <Image
        width={160}
        height={96}
        src={"/assets/images/PNG/logo_large_white.png"}
        alt="Alpha Engineering"
      />
    </Link>
  ),
